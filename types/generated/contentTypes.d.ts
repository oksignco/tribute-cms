...
export interface ApiMemorialMemorial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    MarkerImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    ...
    >;
    Narration: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    Obituary: Schema.Attribute.Blocks;
...
export interface ApiMilestoneMilestone extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    MilestoneMedia: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
